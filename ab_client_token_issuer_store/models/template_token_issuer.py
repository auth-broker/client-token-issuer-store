...
T = TypeVar("T", bound="TemplateTokenIssuer")


@_attrs_define
class TemplateTokenIssuer:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        template_token_issuer.additional_properties = d
        return template_token_issuer
