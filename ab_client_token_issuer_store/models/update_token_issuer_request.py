...
T = TypeVar("T", bound="UpdateTokenIssuerRequest")


@_attrs_define
class UpdateTokenIssuerRequest:
    """
    Attributes:
        id (UUID):
        created_by (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_token_issuer_request = cls(
            id=id,
            created_by=created_by,
            name=name,
            token_issuer=token_issuer,
        ...
        update_token_issuer_request.additional_properties = d
        return update_token_issuer_request
